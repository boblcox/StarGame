...
while not done:
    ...
    if menu is True:
        ...
        screen.blit(menutext1, (450, 600))
        screen.blit(menutext2, (600, 700))
        if forcenewgame is False:
            screen.blit(menutext3, (650, 800))
        screen.blit(menutext4, (650, 900))
        screen.blit(menutext5, (650, 1000))

        # Menu selecter
        if menuselect == 1:
            if forcenewgame is False:
                #pygame.draw.circle(screen, WHITE, [590, 825], 30)
                screen.blit(ship1right, [500, 770])
            if forcenewgame is True:
                menuselect = 2
        elif menuselect == 2:
            #pygame.draw.circle(screen, WHITE, [590, 925], 30)
            screen.blit(ship1right, [500, 870])
        elif menuselect == 3:
            #pygame.draw.circle(screen, WHITE, [590, 1025], 30)
            screen.blit(ship1right, [500, 970])
        if gameover is True:
    ...
    #            planet_list4[i][0] = x
        ...
        if astroidinfo1[1] > 1800 or astroidinfo1[3] < 1:
            ...
            astroidinfo1[0] = random.randrange(50, 1550)
            astroidinfo1[2] += 150
            score += 10
            astroidinfo1[3] = 2
        ...
        if score > 100:
            ...
            if astroidinfo2[1] > 1800 or astroidinfo2[3] < 1:
                ...
                astroidinfo2[0] = random.randrange(50, 1550)
                astroidinfo2[2] += 150
                score += 10
                astroidinfo2[3] = 2
        ...
        if score > 300:
            ...
            if astroidinfo3[1] > 1800 or astroidinfo3[3] < 1:
                ...
                astroidinfo3[0] = random.randrange(50, 1550)
                astroidinfo3[2] += 150
                score += 10
                astroidinfo3[3] = 2
        ...
        if score >= 5:
            ...
            if alien1[1] > 1800 or alien1[3] < 1:
                alien1[1] = -25
                alien1[0] = random.randrange(50, 1550)
                alien1[2] += 150
                score += 25
                alien1[3] = 3
        ...
        if score >= 50:
            ...
            if alien2[1] > 1800 or alien2[3] < 1:
                alien2[1] = -25
                alien2[0] = random.randrange(50, 1550)
                alien2[2] += 150
                score += 25
                alien2[3] = 3
        ...
        if score >= 150:
            ...
            if alien3[1] > 1800 or alien3[3] < 1:
                alien3[1] = -25
                alien3[0] = random.randrange(50, 1550)
                alien3[2] += 150
                score += 25
                alien3[3] = 3
        ...
        if score >= 250:
            ...
            if alien4[1] > 1800 or alien4[3] < 1:
                alien4[1] = -25
                alien4[0] = random.randrange(50, 1550)
                alien4[2] += 150
                score += 25
                alien4[3] = 3
        ...
        if score >= 350:
            ...
            if alien5[1] > 1800 or alien5[3] < 1:
                alien5[1] = -25
                alien5[0] = random.randrange(50, 1550)
                alien5[2] += 150
                score += 25
                alien5[3] = 3
        ...
        if score >= 200:
            ...
            if alien1_type1[1] > 1800 or alien1_type1[3] < 1:
                alien1_type1[1] = -25
                alien1_type1[0] = random.randrange(50, 1550)
                alien1_type1[2] += 150
                score += 75
                alien1_type1[3] = 3
        ...
        if score >= 1000:
            ...
            if alien2_type1[1] > 1800 or alien2_type1[3] < 1:
                alien2_type1[1] = -25
                alien2_type1[0] = random.randrange(50, 1550)
                alien2_type1[2] += 150
                score += 75
                alien2_type1[3] = 3
        ...
        if score >= 2000:
            ...
            if alien3_type1[1] > 1800 or alien3_type1[3] < 1:
                alien3_type1[1] = -25
                alien3_type1[0] = random.randrange(50, 1550)
                alien3_type1[2] += 150
                score += 75
                alien3_type1[3] = 3
        ...
        if score >= 400:
            ...
            if alien1_type2[1] > 1800 or alien1_type2[3] < 1:
                alien1_type2[1] = -25
                alien1_type2[0] = random.randrange(50, 1550)
                alien1_type2[2] += 250
                score += 100
                alien1_type2[3] = 3
        ...
        if score >= 1500:
            ...
            if alien2_type2[1] > 1800 or alien2_type2[3] < 1:
                alien2_type2[1] = -25
                alien2_type2[0] = random.randrange(50, 1550)
                alien2_type2[2] += 250
                score += 100
                alien2_type2[3] = 3
        ...
        if gunup[1] > 1800:
            gunup[1] = -25
            gunup[0] = random.randrange(50, 1550)
            gunup[2] += 150
        ...
        if shieldup[1] > 1800:
            shieldup[1] = -25
            shieldup[0] = random.randrange(50, 1550)
            shieldup[2] += 150
        ...
        if lifeup[1] > 1800:
            lifeup[1] = -25
            lifeup[0] = random.randrange(50, 1550)
            lifeup[2] += 150
        ...
        screen.blit(text3, (35, 1565))

        # life bar and lives
        if gunmode == 1:
            firetext = font.render("FIREMODE : NORMAL", True, OFFWHITE)
            screen.blit(firetext, (35, 1410))
        elif gunmode == 2:
            ...
            screen.blit(firetext, (35, 1410))
        if shields > 0:
            pygame.draw.rect(screen, CYAN, pygame.Rect(30, 1450, int(shields) * 8 + 30, 40)), 2
        pygame.draw.rect(screen, RED, pygame.Rect(30, 1500, 830, 50)), 2
        pygame.draw.rect(screen, GREEN, pygame.Rect(30, 1500, int(health) * 8 + 30, 50)), 2
        screen.blit(text2, (45, 1515))
        for i in range(lives):
            pygame.draw.rect(screen, OFFWHITE, pygame.Rect(150 + i * 115, 1560, 100, 30)), 2
